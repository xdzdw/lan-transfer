...
const translations = {
  en: {
    ...
    fileReadFailed: "The browser could not read the pasted or dropped file",
    fileSendFailed: "The file could not be sent. Please try again",
    ...
    sendFullScreenshot: "Send entire screenshot",
  ...
  zh: {
    ...
    fileReadFailed: "浏览器无法读取粘贴或拖入的文件",
    fileSendFailed: "文件发送失败，请重试",
